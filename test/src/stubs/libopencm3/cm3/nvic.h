/**
 * @file nvic.h
 * @brief stubs for nvic.h
 */

#ifndef NVIC_H_
#define NVIC_H_

#define NVIC_ISER(iser_id)		iser_id

#define NVIC_ICER(icer_id)		icer_id

#define NVIC_ISPR(ispr_id)		ispr_id

#define NVIC_ICPR(icpr_id)		icpr_id

#define NVIC_IABR(iabr_id)		iabr_id

#if defined(__ARM_ARCH_6M__)
#define NVIC_IPR32(ipr_id)		ipr_id
#else
#define NVIC_IPR(ipr_id)		ipr_id
#endif
